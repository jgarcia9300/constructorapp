"""
Django settings for constructorapp project.
...
SECRET_KEY = 'django-insecure-^l5&@a9doin#=xoz@4=j9x&)q)dmi4u@hcm%!+$h#*or$wx0sx'
...
INSTALLED_APPS = [
    ...
    'expenses', #registro de la app creada
]
...
ROOT_URLCONF = 'constructorapp.urls'
...
WSGI_APPLICATION = 'constructorapp.wsgi.application'
